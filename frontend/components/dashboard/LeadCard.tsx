    ...
    >
      ...
      {latestDecision && (
        <div className="mt-3 pt-3 border-t border-border/50">
          <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wide text-accent font-medium mb-1">
            <Brain className="w-3 h-3" />
            Agent decided
          </div>
          <div className="text-xs text-textMuted line-clamp-2 leading-relaxed">
